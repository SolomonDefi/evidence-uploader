...
def create_random_item(db: Session, *, owner_id: Optional[int] = None) -> models.UploadItem:
    if owner_id is None:
    ...
    return models.CRUDItem.create_with_owner(db=db, obj_in=item_in, owner_id=owner_id)
